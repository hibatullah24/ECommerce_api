...
namespace ECommerce_api.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public IActionResult Register(RegisterRequest request)
        {
            ...
            {
                _logger.LogError("Register failed with an unexpected error: {message}", ex.Message);
        ...
        public IActionResult Login(LoginRequest request)
        {
            ...
            {
                _logger.LogError("Loging failed with an unexpexted error: {Message}", ex.Message);
                return BadRequest("An unexpected error occurred during login.");
            }
