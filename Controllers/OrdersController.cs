...
namespace ECommerce_api.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        public IActionResult PlaceOrder(DTOs.PlaceOrderRequest request)
        {
            ...
            {
                _logger.LogError("PlaceOrder failed with an unecpected error: {Message}", ex.Message);
                return BadRequest("An unexpected error occurred while placing the order");
            }
        }
        ...
        public IActionResult GetUserOrders(int userId)
        {
            ...
            {
                _logger.LogError("GetUserOrders failed with an unexpected error: {Message}", ex.Message);
                return BadRequest("An unexpected error occurred while retrieving orders.");
            }
